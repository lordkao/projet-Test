...
const DiscoverHealth = ({isLoading,dataPrograms}) => {
    ...
    !isLoading&& console.log(dataPrograms[2].name)
                    ...
                    <View style={styles.discoverHealthContainer}>
                        ...
                        <View style={styles.frameLessons}>
                            ...
                            <View style={[styles.frameContainer]}>
                                <Frameprogram 
                                    title={dataPrograms[0].name} 
                                    urlImage={dataPrograms[0].illustrationUrl} 
                                />
                            </View>
                            ...
                            <View style={[styles.frameContainer,{justifyContent:'space-between'}]}>
                                ...
                                <View style={styles.frameLeft}>
                                    <Frameprogram 
                                        title={dataPrograms[1].name} 
                                        urlImage={dataPrograms[1].illustrationUrl} 
                                    />
                                </View>

                                <View style={styles.frameLeft}>
                                    <Frameprogram 
                                        title={dataPrograms[2].name} 
                                        urlImage={dataPrograms[2].illustrationUrl} 
                                    />
                                </View>
